...
public class ODataServlet extends HttpServlet {
  ...
  public String getInitParameter(String name) {
    if (ODataServiceFactory.FACTORY_LABEL.equals(name)) {
      return "jp.co.flect.odatasample.odata.MyODataJPAServiceFactory";
    }
  ...
  private void
      handleRequest(final HttpServletRequest req, final ODataHttpMethod method, final HttpServletResponse resp)
          throws IOException {
System.out.println("******* handleRequest1: " + method);
    try {
...
System.out.println("******* handleRequest2: " + context);
...
System.out.println("******* handleRequest3: " + service);
...
System.out.println("******* createResponse: " + response.getStatus());
...
System.out.println("******* createNotImplementedResponse: " + messageReference);
...
//    resp.setStatus(HttpStatusCodes.NOT_IMPLEMENTED.getStatusCode());
  ...
  private void createMethodNotAllowedResponse(final HttpServletRequest req, final MessageReference messageReference,
      final HttpServletResponse resp) throws IOException {
System.out.println("******* createMehtodNotAllowedResponse: " + messageReference);
    ODataExceptionWrapper exceptionWrapper = new ODataExceptionWrapper(req);
    ODataResponse response =
  ...
  private void createNotAcceptableResponse(final HttpServletRequest req, final MessageReference messageReference,
      final HttpServletResponse resp) throws IOException {
System.out.println("******* createNotAccesptableResponse: " + messageReference);
    ODataExceptionWrapper exceptionWrapper = new ODataExceptionWrapper(req);
    ODataResponse response =
...
System.out.println("******* createServiceUnavailableResponse: " + messageReference);
    ODataExceptionWrapper exceptionWrapper = new ODataExceptionWrapper(req);
    ODataResponse response =
